            ...
            <section class="grid-row grid-row--center">
                ...
                <div class="grid-column span-half pt3 pb3 mobile-m order-1 reveal-on-scroll is-revealing">
                    <div class="relative">
                        ...
                        <h3 class="info-image relative z2">Nome Utente: <%=session.getAttribute("nome") %></h3>
                    	<h6 class="info-image relative z2">Email: <%=session.getAttribute("email") %></h6>
                    	<h6 class="info-image relative z2">Pass: <%=session.getAttribute("pass") %></h6>
                    </div>
                </div>
            </section>
        </div>
